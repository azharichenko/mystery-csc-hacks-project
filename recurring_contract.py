...
creator_mnemonic = "scan tomorrow door jungle bundle entire entire corn rough maze tired athlete fame solution canvas era water oppose sphere achieve satisfy parade life about steak"
...
def approval_program():
    on_creation = Seq([App.globalPut(Bytes("Count"), Int(0)), Return(Int(1))])
